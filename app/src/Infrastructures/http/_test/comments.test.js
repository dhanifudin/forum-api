...
describe('/comments endpoint', () => {
  ...
  describe('when POST /threads/{threadId}/comments', () => {
    it('should response 201 and comments persisted', async () => {
      ...
      const { data: { addedThread } } = JSON.parse(postThreadResponse.payload)
      ...
      const { data: { addedComment } } = JSON.parse(postCommentResponse.payload)
